...
# Get absolute path of hanumanji.svg in the same folder as hanumanji.py
base_dir = os.path.dirname(os.path.abspath(__file__))
svg_path = os.path.join(base_dir, "hanumanji.svg")

pen = sketch_from_svg(svg_path, scale=70)
pen.draw()
